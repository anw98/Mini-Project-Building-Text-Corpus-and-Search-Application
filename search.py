...
es = Elasticsearch(HOST="http://localhost", PORT=9200, http_auth=('elastic', 'cFGPaJgzB7iK9GRW_xgZ'))
...
def search_query_filtered(search_term, artist_filter, genre_filter, music_filter, lyrics_filter):
    ...
    select_type, strip_term = intent_classifier(english_term)
    if select_type:
        list_songs, artists, genres, music, lyrics = top_most_filter_text(strip_term, artist_filter, genre_filter,
                                                                          music_filter, lyrics_filter)
    else:
        list_songs, artists, genres, music, lyrics = search_filter_text(search_term, artist_filter, genre_filter,
                                                                        music_filter, lyrics_filter)
